...
var symbolics = {
  ...
  yellow: ['#FFF8E7', '#FFF2CF', '#FFE6A0', '#FFDA71', '#FFBE03', '#D4AB36', '#D4AB36', '#A8872B', '#624F19'],
  orange: ['#FFF4E6', '#FFE5BF', '#FFCB80', '#FFB141', '#FF9802', '#FF8601', '#FF7301', '#994500', '#402100']
};

var normalizeSymbolic = Object.keys(symbolics).reduce(function (acc, key) {
  var start = 0;
  var colors = symbolics[key];
  colors.forEach(function (color, index) {
      var num = index === 0 ? 50 : start += 100;
      acc[key + "-" + num] = color;
  });
  return acc;
}, {});
