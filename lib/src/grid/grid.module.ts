...
import { AgGridModule, BaseComponentFactory, Ng2ComponentFactory } from 'ag-grid-angular';
...
@NgModule({
  imports: [CommonModule, DatoButtonModule, DatoLinkButtonModule, DatoIconButtonModule, DatoIconModule, DatoTextModule, DatoThemesModule, AgGridModule],
  providers: [GridToolbarService, DatoGridHelper, Ng2ComponentFactory, { provide: BaseComponentFactory, useExisting: Ng2ComponentFactory }],
